	...
	return (
		<Dialog isOpen={isOpen} onClose={onClose} className="max-w-3xl">
			...
			<div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-xl">
					<div>
						<h2 className="text-xl font-bold text-gray-900">Create Issue from Text</h2>
				...
				<form onSubmit={handleSubmit} className="p-6">
					<div className="mb-4">
						<label htmlFor="issue-text" className="block text-sm font-medium text-gray-900 mb-2">
						...
						<p className="mt-2 text-xs text-gray-500">
							💡 Tip: Include title, requester, priority, status, assignee, and description for best results
						</p>
					</div>
